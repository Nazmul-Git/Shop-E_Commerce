...
import candleImg from '../../../images/flower.jpg'

const Container2 = () => {
    return (
        <div className='md:grid grid-cols-2 m-4 mt-20 md:p-10  mt-133px relative bg-slate-200'>
            ...
            <div className=''>
                <img src={candleImg} alt="candle" className='h-full shadow-lg shadow-gray-400'/> 
            </div>
        </div>
    );
};
